...
## Modified from the Archcraft Scripts, originally made by
## Copyright (C) 2020-2024 Aditya Shakya <adi1090x@gmail.com>
##
## Post installation script for LunaWolf (Executes on target system to perform various operations)
...
_remove_unwanted_packages() {
    local _packages_to_remove=('calamares-config-lunawolf'
							   'calamares'
							   'archinstall'
...
_perform_various_stuff() {
	...
	cp -rf /usr/share/grub/themes/lunawolf /boot/grub/themes
    ...
    [[ -x `which lunawolf-hooks-runner` ]] && lunawolf-hooks-runner
